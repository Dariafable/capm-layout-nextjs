...
const Hero = () => {
  return (
    <section className='max-container padding-container py-10 pb-32 flex flex-col gap-20 lg:py-20 xl:flex-row md:gap-28'>
      ...
      <div className='relative z-20 flex flex-1 flex-col xl:w-1/2'>
        ...
        <div className='my-11 flex flex-wrap gap-5'>
          ...
          <p className='text-blue-70 bold-16 lg:bold-20'>
            198k<span className='ml-1 regular-16 lg:regular-20'>Excellent Reviews</span>
          </p>
        </div>
      ...
      <div className='relative flex flex-1 items-start'>
        <div className='w-[268px] px-7 py-8 relative z-20 flex flex-col gap-8 rounded-3xl bg-green-90 '>
